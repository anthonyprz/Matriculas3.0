...
/**
 * Servlet implementation class BorrarAL
 */
public class BorrarAL extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String dni = request.getParameter("dniALUM");
		...
		try{
			...
			String borrar ="delete FROM alumnos where dni ='"+dni+"';";
			...
			out.println("<p>el alumno con el dni: "+request.getParameter("dniALUM")+ " ha sido eliminado de la base de datos</p>");
